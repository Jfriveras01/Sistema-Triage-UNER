...
public class TriagesRealizados extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Traiges Hechos");
        ...
        jTextField3.setText("Nombre Med");

        jTextField4.setText("Dni Paci");
        ...
        jTextField5.setText("Puntuacion");

        jTextField6.setText("Apellido Med");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TriagesRealizados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TriagesRealizados dialog = new TriagesRealizados(new javax.swing.JFrame(), true);
